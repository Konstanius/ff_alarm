...
int _personEstimateSize(
  ...
  bytesCount += 3 + object.allowedUnits.length * 8;
...
void _personSerialize(
  ...
  writer.writeLongList(offsets[0], object.allowedUnits);
...
Person _personDeserialize(
  ...
  final object = Person(
    allowedUnits: reader.readLongList(offsets[0]) ?? [],
    firstName: reader.readString(offsets[1]),
    id: id,
    lastName: reader.readString(offsets[2]),
    qualifications: reader.readString(offsets[3]),
...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  QueryBuilder<Person, Person, QAfterFilterCondition>
      allowedUnitsElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'allowedUnits',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition>
      allowedUnitsElementGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> allowedUnitsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> allowedUnitsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'allowedUnits',
        0,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> allowedUnitsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'allowedUnits',
        0,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> allowedUnitsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> qualificationsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'qualifications',
        value: '',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> updatedEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'updated',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> updatedGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> updatedLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> updatedBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PersonQuerySortBy on QueryBuilder<Person, Person, QSortBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> sortByQualifications() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qualifications', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByQualificationsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qualifications', Sort.desc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByUpdated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updated', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> sortByUpdatedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQuerySortThenBy on QueryBuilder<Person, Person, QSortThenBy> {
  ...
  QueryBuilder<Person, Person, QAfterSortBy> thenByQualifications() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qualifications', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByQualificationsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'qualifications', Sort.desc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByUpdated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updated', Sort.asc);
    });
  }

  QueryBuilder<Person, Person, QAfterSortBy> thenByUpdatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'updated', Sort.desc);
    });
  }
...
extension PersonQueryWhereDistinct on QueryBuilder<Person, Person, QDistinct> {
  QueryBuilder<Person, Person, QDistinct> distinctByAllowedUnits() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'allowedUnits');
    });
  }
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByQualifications(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QDistinct> distinctByUpdated() {
    return QueryBuilder.apply(this, (query) {
...
extension PersonQueryProperty on QueryBuilder<Person, Person, QQueryProperty> {
  ...
  QueryBuilder<Person, List<int>, QQueryOperations> allowedUnitsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'allowedUnits');
    });
  }
  ...
  QueryBuilder<Person, String, QQueryOperations> qualificationsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'qualifications');
    });
  }

  QueryBuilder<Person, DateTime, QQueryOperations> updatedProperty() {
    return QueryBuilder.apply(this, (query) {

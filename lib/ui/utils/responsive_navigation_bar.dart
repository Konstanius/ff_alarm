...
/// Authored by package author: https://pub.dev/packages/responsive_navigation_bar (Version 4.0.4)
    ...
    for (final button in navigationBarButtons) {
      ...
      buttons.add(
        _Button(
          ...
          padding: button.padding ?? (deviceWidth >= 650 ? const EdgeInsets.symmetric(horizontal: 30, vertical: 10) : const EdgeInsets.symmetric(horizontal: 8, vertical: 10)),
